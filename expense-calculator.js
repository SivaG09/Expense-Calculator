...
function add_expense() {
  ...
  var date = document.getElementsByClassName("form-input")[1].value;//made change, wrong index
  var note = document.getElementsByClassName("form-input")[2].value;//made change, wrong index
